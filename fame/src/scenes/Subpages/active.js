				...
				<View>
					<View style={{height:pxToDp(70), flexDirection:'row', backgroundColor:'#999'}}>
						<TouchableOpacity style={{flex: 1, alignItems:'center'}}>
							<View style={{width:pxToDp(180),height:pxToDp(70), alignItems:'center',borderBottomColor:'#69bdd0', borderBottomWidth:pxToDp(12)}}>
					...
					<View style={{marginHorizontal:pxToDp(24), flexDirection:'row',alignItems:'center', justifyContent:'center', borderBottomColor:'#999',borderBottomWidth:pxToDp(1)}}>
						...
						<View style={{marginHorizontal:pxToDp(30)}}>
							<Text style={{width:pxToDp(400), fontSize:pxToDp(40), marginVertical:pxToDp(26)}}>上海市闵行区马桥镇镇政府</Text>
