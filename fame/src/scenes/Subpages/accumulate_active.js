	...
	render() {
		return (
			<ScrollView style={styles.container}>
				...
				<View>
					<View style={{height:pxToDp(70), flexDirection:'row', backgroundColor:'#999'}}>
						<TouchableOpacity style={{flex: 1, marginHorizontal: pxToDp(20),alignItems:'center',borderBottomColor: this.state.borColor1 , borderBottomWidth:pxToDp(12)}} onPress={this._changePage.bind(this,1)}>
							<Text style={{width:pxToDp(180), textAlign:'center', color:'white', fontSize:pxToDp(34)}}>
								社区服务
							</Text>
						</TouchableOpacity>
						<TouchableOpacity style={{flex: 1, marginHorizontal: pxToDp(20), alignItems:'center',borderBottomColor: this.state.borColor2 , borderBottomWidth:pxToDp(12)}} onPress={this._changePage.bind(this,2)}>
							<Text style={{width:pxToDp(180), textAlign:'center', color:'white', fontSize:pxToDp(34)}}>
								公益活动
							</Text>
						</TouchableOpacity>
						<TouchableOpacity style={{flex: 1, marginHorizontal: pxToDp(20), alignItems:'center',borderBottomColor: this.state.borColor3 , borderBottomWidth:pxToDp(12)}} onPress={this._changePage.bind(this,3)}>
							<Text style={{width:pxToDp(180), textAlign:'center', color:'white', fontSize:pxToDp(34)}}>
								其他
							</Text>
						</TouchableOpacity>
